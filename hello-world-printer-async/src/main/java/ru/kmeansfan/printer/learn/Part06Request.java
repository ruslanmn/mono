...
import ru.kmeansfan.printer.learn.repository.ReactiveRepository;
import ru.kmeansfan.printer.learn.repository.ReactiveUserRepository;
...
//========================================================================================
    ...
    //  that prints "Starring:" at first, "firstname lastname" for all values and "The end!" on complete
    ...
    public static void main(String[] args) {
        StepVerifier.create(
            new Part06Request().fluxWithDoOnPrintln()
        )
            .expectNextCount(4)
            .verifyComplete();
    }
